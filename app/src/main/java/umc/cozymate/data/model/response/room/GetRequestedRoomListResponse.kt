...
import umc.cozymate.data.model.response.roomlog.NotificationLogResponse.Result.LogItem

@Serializable
data class GetRequestedRoomListResponse(
    @SerialName("code")
    val code: String,
