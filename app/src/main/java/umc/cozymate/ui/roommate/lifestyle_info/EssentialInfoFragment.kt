...
//            selectedSleepHabits = it.getStringArrayList("sleepHabitCheck") ?: emptyList()
                selectedSleepHabits = it.getStringArrayList("sleepHabitCheck")?.toMutableList() ?: mutableListOf()
...
//            selectedPersonalitys = it.getStringArrayList("personalityCheck") ?: emptyList()
                selectedPersonalitys = it.getStringArrayList("personalityCheck")?.toMutableList() ?: mutableListOf()
