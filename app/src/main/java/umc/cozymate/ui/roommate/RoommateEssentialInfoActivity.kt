...
//            setTextColor(resources.getColor(R.color.unuse_font, null))
//            background = resources.getDrawable(R.drawable.custom_tv_default_background, null)
//        }
//
//        // Select new option
...
//        selectedWakeTimeOption?.apply {
//            setTextColor(resources.getColor(R.color.main_blue, null))
//            background = resources.getDrawable(R.drawable.custom_tv_selected_background, null)
//        }
//
