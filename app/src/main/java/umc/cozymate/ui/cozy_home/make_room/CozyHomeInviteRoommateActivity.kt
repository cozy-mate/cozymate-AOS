...
import umc.cozymate.databinding.ActivityCozyHomeInviteRoommateBinding
...
class CozyHomeInviteRoommateActivity : AppCompatActivity() {

    private lateinit var binding: ActivityCozyHomeInviteRoommateBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityCozyHomeInviteRoommateBinding.inflate(layoutInflater)
    ...
    fun loadFragment2() {
        supportFragmentManager.beginTransaction()
            .replace(R.id.fragment_container, CozyHomeSelectRoommateFragment())
            .addToBackStack(null)
            .commit()
    }
