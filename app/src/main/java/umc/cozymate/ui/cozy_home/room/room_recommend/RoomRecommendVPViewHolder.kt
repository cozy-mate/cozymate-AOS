...
class RoomRecommendVPViewHolder(
    ...
    fun bind(item: GetRecommendedRoomListResponse.Result.Result) {
        with(binding) {
            ...
            if (item.equalMemberStatNum != null) {
                // 선호항목 1
                val pref1 =
                    Preference.entries.find { it.pref == item.equalMemberStatNum.entries.toList()[0].key }
                if (pref1 != null) {
                    ...
                    when (item.equalMemberStatNum[pref1.pref]) {
                        ...
                        item.numOfArrival -> {
                            ...
                            tvCriteriaContent1.text =
                                "${item.equalMemberStatNum[pref1.pref].toString()}명 일치"
                ...
                // 선호항목 2
                val pref2 =
                    Preference.entries.find { it.pref == item.equalMemberStatNum.entries.toList()[1].key }
                if (pref2 != null) {
                    ...
                    when (item.equalMemberStatNum[pref2.pref]) {
                        ...
                        item.numOfArrival -> {
                            ...
                            tvCriteriaContent2.text =
                                "${item.equalMemberStatNum[pref2.pref].toString()}명 일치"
                ...
                // 선호항목 3
                val pref3 =
                    Preference.entries.find { it.pref == item.equalMemberStatNum.entries.toList()[2].key }
                if (pref3 != null) {
                    ...
                    when (item.equalMemberStatNum[pref3.pref]) {
                        ...
                        item.numOfArrival -> {
                            ...
                            tvCriteriaContent3.text =
                                "${item.equalMemberStatNum[pref3.pref].toString()}명 일치"
                ...
                // 선호항목 4
                val pref4 =
                    Preference.entries.find { it.pref == item.equalMemberStatNum.entries.toList()[3].key }
                if (pref4 != null) {
                    ...
                    when (item.equalMemberStatNum[pref4.pref]) {
                        ...
                        item.numOfArrival -> {
                            ...
                            tvCriteriaContent4.text =
                                "${item.equalMemberStatNum[pref4.pref].toString()}명 일치"
