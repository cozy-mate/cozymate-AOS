        ...
        viewModel.profileImage.observe(viewLifecycleOwner, Observer { img ->
            if (img != null) {
                when (img) {
                    ...
                    4 -> binding.ivChar.setImageResource(R.drawable.character_id_6)
                    5 -> binding.ivChar.setImageResource(R.drawable.character_id_4)
                    6 -> binding.ivChar.setImageResource(R.drawable.character_id_5)
                    7 -> binding.ivChar.setImageResource(R.drawable.character_id_10)
                    8 -> binding.ivChar.setImageResource(R.drawable.character_id_9)

                    9 -> binding.ivChar.setImageResource(R.drawable.character_id_15)
                    10 -> binding.ivChar.setImageResource(R.drawable.character_id_13)
                    ...
                    13 -> binding.ivChar.setImageResource(R.drawable.character_id_14)
                    14 -> binding.ivChar.setImageResource(R.drawable.character_id_8)
                    15 -> binding.ivChar.setImageResource(R.drawable.character_id_7)
