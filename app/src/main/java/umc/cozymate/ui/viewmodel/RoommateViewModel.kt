    ...
    fun sendUserInfo(request: UserInfoRequest) {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            repository.sendUserInfo(accessToken, request).onSuccess {
                ...
                val editor = sharedPreferences.edit()
                editor.putBoolean(KEY_IS_LIFESTYLE_EXIST, false)
...
fun getFilteredUserInfo(accessToken: String, page: Int) {
    ...
    fun saveUserLifestyleInfo() {
        ...
        editor.putString("user_smokingStatus", _memberLifestyleInfo.value!!.memberStatDetail.smokingStatus)
        editor.putStringSet("user_sleepingHabits", _memberLifestyleInfo.value!!.memberStatDetail.sleepingHabits.toSet())
        editor.putString("user_coolingIntensity", _memberLifestyleInfo.value!!.memberStatDetail.coolingIntensity)
        editor.putString("user_heatingIntensity", _memberLifestyleInfo.value!!.memberStatDetail.heatingIntensity)
        ...
        editor.putString("user_sharingStatus", _memberLifestyleInfo.value!!.memberStatDetail.sharingStatus)
        editor.putString("user_gamingStatus", _memberLifestyleInfo.value!!.memberStatDetail.gamingStatus)
        editor.putString("user_callingStatus", _memberLifestyleInfo.value!!.memberStatDetail.callingStatus)
        editor.putString("user_studyingStatus", _memberLifestyleInfo.value!!.memberStatDetail.studyingStatus)
        editor.putString("user_eatingStatus", _memberLifestyleInfo.value!!.memberStatDetail.eatingStatus)
        editor.putString("user_cleannessSensitivity", _memberLifestyleInfo.value!!.memberStatDetail.cleannessSensitivity)
        editor.putString("user_noiseSensitivity", _memberLifestyleInfo.value!!.memberStatDetail.noiseSensitivity)
        ...
        editor.putStringSet("user_personalities", _memberLifestyleInfo.value!!.memberStatDetail.personalities.toSet())
